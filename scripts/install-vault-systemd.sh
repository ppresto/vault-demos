...
sudo curl --silent -Lo ${SYSTEMD_DIR}/vault.service https://raw.githubusercontent.com/ppresto/vault-learning/master/scripts/systemd/vault.service
sudo curl --silent -Lo ${SYSTEMD_DIR}/consul-online.service https://raw.githubusercontent.com/ppresto/vault-learning/master/scripts/systemd/consul-online.service
sudo curl --silent -Lo ${SYSTEMD_DIR}/consul-online.target https://raw.githubusercontent.com/ppresto/vault-learning/master/scripts/systemd/consul-online.target
sudo curl --silent -Lo ${SYSTEMD_DIR}/consul-online.sh https://raw.githubusercontent.com/ppresto/vault-learning/master/scripts/systemd/consul-online.sh
