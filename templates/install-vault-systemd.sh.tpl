...
curl https://raw.githubusercontent.com/ppresto/vault-learning/master/scripts/install-vault.sh | bash
...
curl https://raw.githubusercontent.com/ppresto/vault-learning/master/scripts/install-vault-systemd.sh | bash
